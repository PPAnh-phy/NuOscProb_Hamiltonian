...
DENSITY_MATTER_CRUST_G_PER_CM3 = 2.825
r"""float: Module-level constant
...
NUM_DENSITY_E_EARTH_CRUST = DENSITY_MATTER_CRUST_G_PER_CM3 * ELECTRON_FRACTION_EARTH_CRUST * Na * 7.645373e-33   # eV
...
S12_NO_BF = np.sin(theta12)
#S12_NO_BF = sqrt(0.304)
r"""float: Module-level constant
...
S23_NO_BF = np.sin(theta23)
#S23_NO_BF = sqrt(0.499)
r"""float: Module-level constant
...
S13_NO_BF = np.sin(theta13)
#S13_NO_BF = sqrt(2.246e-2)
r"""float: Module-level constant
